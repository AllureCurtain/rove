...
use crate::types::{UserInputProvider, UserInputRequest};
...
#[derive(Debug)]
#[doc(hidden)]
pub struct RegisteredUserInput {
    pub input_id: CallId,
...
#[doc(hidden)]
pub async fn request_input<P>(provider: &P, prompt: String) -> Result<String, ToolError>
where
