...
| [implementation-guide.md](implementation-guide.md) | Maintainer-focused implementation guide with startup paths, the current `rove tui` first slice, runtime flow, state artifacts, verification, and known gaps. |
