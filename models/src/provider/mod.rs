...
pub use id::{
    ANTHROPIC_MESSAGES_PROTOCOL, EXTERNAL_ADAPTER_V1_PROTOCOL, FAKE_PROTOCOL, OLLAMA_CHAT_PROTOCOL,
    OPENAI_CHAT_PROTOCOL, OPENAI_RESPONSES_PROTOCOL, WireProtocolId, WireProtocolIdError,
};
