...
use crate::tools::rag::types::RetrievedChunk;
...
mod tests {
    ...
    fn build_rag_reranker_requires_key_when_fallback_disabled() {
        ...
        let err = match crate::interfaces::cli::index::build_rag_reranker(&config) {
    ...
    fn build_rag_reranker_falls_back_to_noop_when_key_missing_and_fallback_enabled() {
        ...
        let reranker = crate::interfaces::cli::index::build_rag_reranker(&config).unwrap();
