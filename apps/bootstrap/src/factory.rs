use crate::config::{AppConfig, FallbackProviderConfig, ProviderOptions};
use rove_models::ModelClient;
use rove_models::anthropic::AnthropicClient;
use rove_models::fake::FakeModelClient;
use rove_models::health::{HealthConfig, ModelHealthStore};
use rove_models::ollama::OllamaClient;
use rove_models::openai::OpenAiClient;
use rove_models::openai_responses::OpenAiResponsesClient;
...
impl ProviderSpec {
    ...
    fn fallback(provider: &FallbackProviderConfig) -> Self {
        Self {
