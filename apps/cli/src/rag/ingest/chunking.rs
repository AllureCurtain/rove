use crate::rag::types::{DocumentChunk, ParsedDocument, sha256_hex};
...
impl ChunkingStrategy for MixedCodeMarkdownChunker {
    ...
    fn chunk(&self, document: &ParsedDocument) -> Vec<DocumentChunk> {
        match document.kind {
            crate::rag::types::RetrieveKind::Code => self.code.chunk(document),
            crate::rag::types::RetrieveKind::Docs => self.markdown.chunk(document),
        }
    }
}
...
mod tests {
    use super::*;
    use crate::rag::types::{ParsedDocument, RetrieveKind};
